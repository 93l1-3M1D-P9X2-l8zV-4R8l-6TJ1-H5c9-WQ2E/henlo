                ...
                constructor(e, t, n) {
                    ...
                    Xr(this, Fr, "f").on("markTriggersActivated", (e=>{
                        e.forEach((e=>{
                            ...
                            Me.kg.info(`ðŸŽ‰ Trigger activated, ID: ${e}, Tag: ${t.tag}`)) : Me.kg.error(`trigger not found, ID: ${e}`)
                        }
                        ))
                    }
                    )),
                    Xr(this, Fr, "f").on("markTriggersClaimed", (e=>{
                        e.forEach((e=>{
                            ...
                            Me.kg.info(`ðŸŽ‰ Trigger claimed, ID: ${e}, Tag: ${t.tag}`)) : Me.kg.error(`trigger not found, ID: ${e}`)
                        }
                        ))
                    }
                    )),
